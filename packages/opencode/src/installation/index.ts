...
export namespace Installation {
  ...
  export const USER_AGENT = `opensurfer/${CHANNEL}/${VERSION}/${Flag.OPENSURFER_CLIENT}`
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@opensurfer/Installation") {}
      ...
      Effect.gen(function* () {
        ...
        const upgradeCurl = Effect.fnUntraced(
          function* (target: string) {
            const response = yield* httpOk.execute(HttpClientRequest.get("https://raw.githubusercontent.com/PewterZz/opensurfer/dev/install"))
        ...
        const methodImpl = Effect.fn("Installation.method")(function* () {
          if (process.execPath.includes(path.join(".opensurfer", "bin"))) return "curl" as Method
