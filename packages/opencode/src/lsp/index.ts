...
export namespace LSP {
  ...
  const filterExperimentalServers = (servers: Record<string, LSPServer.Info>) => {
    if (Flag.OPENSURFER_EXPERIMENTAL_LSP_TY) {
      if (servers["pyright"]) {
        log.info("LSP server pyright is disabled because OPENSURFER_EXPERIMENTAL_LSP_TY is enabled")
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@opensurfer/LSP") {}
