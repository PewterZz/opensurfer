...
export namespace ShareNext {
  ...
  const disabled = process.env["OPENSURFER_DISABLE_SHARE"] === "true" || process.env["OPENSURFER_DISABLE_SHARE"] === "1"
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@opensurfer/ShareNext") {}
