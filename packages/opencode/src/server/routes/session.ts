  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all OpenSurfer sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific OpenSurfer session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new OpenSurfer session for interacting with AI assistants and managing conversations.",
